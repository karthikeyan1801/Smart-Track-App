sap.ui.define([
	...
	return Controller.extend("SmartTrack.view.EVMUnexpectedDetail", {
		formatter: formatter,
		onInit: function () {
		...
		fnBindContainers: function (sGuid, sEVMGuid, sEE) {
			...
			this.getView().byId("evmUnexpectedDetailContainer").bindAggregation("items", {
				path: "/FreightOrderEventMessageDetailsS",
				filters: aFilters,
